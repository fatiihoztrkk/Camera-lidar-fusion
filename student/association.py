...
class Association:
    ...
    def get_closest_track_and_meas(self):
        ...
        self.association_matrix = np.delete(np.delete(A, ind_track, 0), ind_meas, 1)
    ...
    def gating(self, MHD):
        ...
        ############
        dof = params.dim_state
        g_thresh = params.gating_threshold
        limit = chi2.ppf(g_thresh, df=dof)
        return MHD < limit
